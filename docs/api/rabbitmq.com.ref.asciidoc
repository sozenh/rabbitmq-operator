...
[id="{anchor_prefix}-github-com-rabbitmq-cluster-operator-v2-api-v1beta1-rabbitmqclustercondition"]
...
|===
| Field | Description
| *`type`* __xref:{anchor_prefix}-github-com-rabbitmq-cluster-operator-v2-api-v1beta1-rabbitmqclusterconditiontype[$$RabbitmqClusterConditionType$$]__ | Type indicates the scope of RabbitmqCluster status addressed by the condition.
...
| *`lastTransitionTime`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.23/#time-v1-meta[$$Time$$]__ | The last time this Condition type changed.
|===


[id="{anchor_prefix}-github-com-rabbitmq-cluster-operator-v2-api-v1beta1-rabbitmqclusterconditiontype"]
==== RabbitmqClusterConditionType (string) 



.Appears In:
****
- xref:{anchor_prefix}-github-com-rabbitmq-cluster-operator-v2-api-v1beta1-rabbitmqclustercondition[$$RabbitmqClusterCondition$$]
****
...
| *`envConfig`* __string__ | Modify to add to the rabbitmq-env.conf file.
...
|===
| Field | Description
| *`service`* __xref:{anchor_prefix}-github-com-rabbitmq-cluster-operator-v2-api-v1beta1-service[$$Service$$]__ | Override configuration for the RabbitMQ Service.
...
|===
| Field | Description
| *`replicas`* __integer__ | Replicas is the number of nodes in the RabbitMQ cluster.
...
|===
| Field | Description
| *`conditions`* __xref:{anchor_prefix}-github-com-rabbitmq-cluster-operator-v2-api-v1beta1-rabbitmqclustercondition[$$RabbitmqClusterCondition$$] array__ | Set of Conditions describing the current state of the RabbitmqCluster
