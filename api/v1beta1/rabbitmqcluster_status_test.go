...
//		Expect(rabbitmqClusterStatus.Conditions[0].Type).To(Equal(AllReplicasReady))
//		Expect(rabbitmqClusterStatus.Conditions[1].Type).To(Equal(ClusterAvailable))
//		Expect(rabbitmqClusterStatus.Conditions[2].Type).To(Equal(NoWarnings))
//		Expect(rabbitmqClusterStatus.Conditions[3].Type).To(Equal(ReconcileSuccess))
//	})
//
