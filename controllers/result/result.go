...
func (d done) Output() (ctrl.Result, error) {
	return ctrl.Result{
		Requeue: true, RequeueAfter: 30 * time.Second}, nil
}
...
type callBackSoonError struct {
	err   error
	after time.Duration
}

func (c callBackSoonError) Completed() bool {
	return true
}

func (c callBackSoonError) Output() (ctrl.Result, error) {
	return ctrl.Result{Requeue: true, RequeueAfter: c.after}, c.err
}

func (c callBackSoonError) IsDone() bool {
	return false
}

func (c callBackSoonError) IsError() bool {
	return true
}

func (c callBackSoonError) IsRequeue() bool {
	return true
}

func (c callBackSoonError) GetError() error {
	return c.err
}
...
func RequeueSoonError(after time.Duration, e error) ReconcileResult {
	return callBackSoonError{after: after, err: e}
}
